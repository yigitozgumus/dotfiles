...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-conventionalcommits", "LuaSnip", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-rg", "vim-snippets", "friendly-snippets", "cmp-path", "cmp-nvim-lua", "cmp-treesitter" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-python", "nvim-dap-go", "nvim-dap-virtual-text" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-surround', 'dressing.nvim', 'nvim-notify', 'nvim-treesitter-textsubjects', 'lualine.nvim', 'nvim-treesitter-context', 'vim-surround-funk', 'mini.nvim', 'nvim-bufferline.lua', 'nvim-treesitter-textobjects'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
