...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-snippets", "cmp-rg", "cmp-nvim-lsp-signature-help", "cmp-conventionalcommits", "cmp-path", "cmp-treesitter", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lua", "friendly-snippets", "cmp-nvim-lsp", "LuaSnip", "cmp_luasnip" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-surround', 'nvim-treesitter-context', 'nvim-treesitter-textobjects', 'nvim-notify', 'nvim-bufferline.lua', 'mini.nvim', 'lualine.nvim', 'vim-surround-funk', 'indent-blankline.nvim', 'nvim-treesitter-textsubjects'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
