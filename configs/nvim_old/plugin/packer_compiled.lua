...
_G.packer_plugins = {
  ...
  ["goto-preview"] = {
    ...
    loaded = true,
    path = "/Users/yigitozgumus/.local/share/nvim/site/pack/packer/start/goto-preview",
  ...
  ["nvim-cmp"] = {
    after = { "vim-snippets", "LuaSnip", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp_luasnip", "cmp-rg", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-conventionalcommits", "cmp-treesitter", "cmp-cmdline", "cmp-path", "friendly-snippets" },
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/yigitozgumus/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
    url = "https://github.com/weilbith/nvim-code-action-menu"
  },
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "nvim-dap-go", "nvim-dap-ui", "nvim-dap-python" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-surround', 'mini.nvim', 'lualine.nvim', 'indent-blankline.nvim', 'nvim-treesitter-textobjects', 'nvim-treesitter-context', 'nvim-treesitter-textsubjects', 'nvim-notify', 'dressing.nvim', 'nvim-bufferline.lua', 'vim-surround-funk'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
