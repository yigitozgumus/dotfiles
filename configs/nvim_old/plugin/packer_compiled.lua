...
_G.packer_plugins = {
  ...
  ["noice.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/yigitozgumus/.local/share/nvim/site/pack/packer/opt/noice.nvim",
    url = "https://github.com/folke/noice.nvim"
  },
  ["notifier.nvim"] = {
    config = { "\27LJ\2\n:\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\rnotifier\frequire\0" },
    loaded = true,
    path = "/Users/yigitozgumus/.local/share/nvim/site/pack/packer/start/notifier.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-nvim-lsp", "cmp-rg", "tabout.nvim", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "friendly-snippets", "cmp-treesitter", "cmp-conventionalcommits", "cmp-path", "cmp-nvim-lua", "vim-snippets", "cmp_luasnip", "cmp-buffer" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'luv-vimdocs', 'nvim-treesitter-textsubjects', 'lualine.nvim', 'vim-test', 'vim-surround-funk', 'vim-surround', 'indent-blankline.nvim', 'nvim-treesitter-context', 'nvim-notify', 'nvim-luaref', 'nvim-bufferline.lua', 'nvim-ts-rainbow', 'neoscroll.nvim', 'dressing.nvim', 'mini.nvim', 'nvim-treesitter-textobjects', 'nvim-ts-context-commentstring'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
