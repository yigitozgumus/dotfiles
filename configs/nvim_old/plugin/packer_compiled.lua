...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-treesitter-context', 'nvim-treesitter-textobjects', 'nvim-notify'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
