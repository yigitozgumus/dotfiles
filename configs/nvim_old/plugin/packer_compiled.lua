...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-treesitter", "vim-snippets", "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-conventionalcommits", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-path", "friendly-snippets", "cmp-nvim-lua" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-go", "nvim-dap-virtual-text", "nvim-dap-ui", "nvim-dap-python" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-notify', 'vim-surround', 'nvim-treesitter-context', 'dressing.nvim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'vim-surround-funk', 'indent-blankline.nvim', 'lualine.nvim', 'mini.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
