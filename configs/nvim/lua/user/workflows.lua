...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd $HOME/Documents/Notes/Personal<cr>", { desc = "Navigate to Obsidian Vault" })
--
...
vim.keymap.set("n", "<leader>om", ":Obsidian", { desc = "Open Obsidian App" })
--
-- search for files in full vault
vim.keymap.set(
  "n",
  "<leader>of",
  ':Telescope find_files search_dirs={"$HOME/Documents/Notes/Personal"}<cr>',
  { desc = "Search Vault Files" }
)
vim.keymap.set(
  "n",
  "<leader>oz",
  ':Telescope live_grep search_dirs={"$HOME/Documents/Notes/Personal"}<cr>',
  { desc = "Search Anything in Vault" }
)
--
