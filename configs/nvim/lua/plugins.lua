...
function M.setup()
    ...
    local function plugins(use)
        ...
        use({
            "catppuccin/nvim",
            as = "catppuccin",
            config = function() require("config.catppuccin").setup() end,
            disable = false
        })
        ...
        use({
            "rktjmp/lush.nvim",
            cmd = {
                "LushRunQuickstart", "LushRunTutorial", "Lushify", "LushImport"
            },
            disable = true
        })
        use({
        ...
        use({
            ...
            requires = {
                ...
                {"jvgrootveld/telescope-zoxide"}, {"Zane-/cder.nvim"},
        ...
        use({
            ...
            requires = {
                ...
                {"jayp0521/mason-null-ls.nvim"}, "folke/neodev.nvim",
        ...
        use({
            ...
            config = function()
                ...
                vim.keymap.set("n", "<C-j>", "<Plug>RestNvim",
        ...
        use({
            ...
            module = {"legendary"},
            cmd = {"Legendary"},
            config = function() require("config.legendary").setup() end,
            disable = false
        })
        ...
        use({
            ...
            module = {
                "harpoon", "harpoon.cmd-ui", "harpoon.mark", "harpoon.ui",
                "harpoon.term", "telescope._extensions.harpoon"
            },
